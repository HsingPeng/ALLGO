...
public class PlaceSpinnerDialog_userdetail_FRAGMENT extends DialogFragment {
	    ...
	    builder.setTitle("选择活动所在地区")
	           ...
	           .setPositiveButton("确定", new DialogInterface.OnClickListener() {
	               ...
	               public void onClick(DialogInterface dialog, int id) {
	            	   ...
	            	   ((UpdateUserDetailACTIVITY)getActivity()).changePosition(placeSpinner.getPosition());
	               }
	           })
	...
	public static PlaceSpinnerDialog_userdetail_FRAGMENT newInstance(String title) {
		PlaceSpinnerDialog_userdetail_FRAGMENT frag = new PlaceSpinnerDialog_userdetail_FRAGMENT();
