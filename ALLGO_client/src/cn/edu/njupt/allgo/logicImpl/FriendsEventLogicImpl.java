...
public class FriendsEventLogicImpl implements FriendsEventLogic {
	...
	public FriendsEventLogicImpl(Context context , RefreshInterFace refresh) {
	...
	public void getEvent(int page, int pagenum) {
        ...
        NetUtil netUtil = new NetUtil("event/friend/timeline", refresh, context, new NetCallBack(){
			@Override
			public void getResult(JSONObject jsonObject) {
				try {
					 if(jsonObject.getString("response").equals("friendevent_timeline")){
							 if(page1 == 1){
